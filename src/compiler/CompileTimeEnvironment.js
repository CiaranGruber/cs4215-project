...
export class EnvironmentPosition {
     ...
     */
    constructor(env_depth, value_index) {
...
export default class CompileTimeEnvironment {
     ...
     */
    get_position(symbol_name, add_if_not_present) {
 ...
 * @private
 */
CompileTimeEnvironment.invalid_position = null;
/**
...
//# sourceMappingURL=CompileTimeEnvironment.js.map