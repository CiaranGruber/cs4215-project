...
export default class UInt8 {
    ...
    /**
     * Initialises a new C UInt8 viewer without the ability to overwrite protected values and in big-endian format
     * @param view The view of the heap with the UInt8
     */
    public constructor(view: HeapDataView);

    /**
     * Initialises a new C UInt8 viewer with the ability to overwrite protected values and in big-endian format
     * @param view The view of the heap with the UInt8
