 ...
 * UInt32
 *
 * Represents a UInt32 for use by the antlr_parser within C Memory
...
/**
 * Allows viewing of UInt32 data views including for the C Heap
 *
...
export default class UInt32 {
     ...
     * @param view The data view with the UInt32
     */
